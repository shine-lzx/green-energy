const features = [
  {
    ...
    title: '高端设备',
    description: '采用行业领先的光伏组件，效率高达23%以上'
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: '专业团队',
    description: '十年以上行业经验，持证上岗，服务更放心'
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: '资金安全',
    description: '银行级资金托管，确保您的每一分钱都用在实处'
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: '政策解读',
    description: '专业团队帮您解读最新政策，最大化享受补贴'
  }
]
